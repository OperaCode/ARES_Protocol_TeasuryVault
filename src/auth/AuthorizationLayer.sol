...
contract AuthorizationLayer is IAuthorizationLayer {
    ...
    constructor() {
        ...
        DOMAIN_SEPARATOR = EIP712Digest.domainSeparator(domain);
    }
    ...
    function verifyAuthorization(
        ...
        bytes32 structHash = keccak256(
            abi.encode(AUTH_TYPEHASH, operationHash, nonces[msg.sender])
        );

        bytes32 digest = EIP712Digest.digest(DOMAIN_SEPARATOR, structHash);
